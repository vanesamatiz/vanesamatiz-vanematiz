...
export default function IntermediateAgreement() {
  const formUrl = "https://docs.google.com/forms/d/e/1FAIpQLSfYAQ3q9ZzBEkpgU-sGVE2ZVVbg_WhwQk2Xl-BVx6sTZzHUPw/viewform?embedded=true";

  return (
    <div className="pt-24 pb-20 bg-brand-pink-light/30 min-h-screen">
      <SEO 
        title="Acuerdo de condiciones – Plan Intermedio | Vanesa Matiz" 
        description="Acuerdo de condiciones para el Plan Intermedio de Terapia de Pareja con Vanesa Matiz."
      />
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-brand-wine leading-tight">
              Acuerdo de condiciones – Plan Intermedio de Terapia de Pareja
            </h1>
          </div>
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed mb-10">
            ...
            <p>
              El Plan Intermedio de Terapia de Pareja está diseñado para trabajar aspectos importantes de la relación como la comunicación, la conexión emocional, la intimidad y las dinámicas relacionales.
            </p>
            <p>
              Antes de iniciar el proceso, es importante que ambos miembros de la pareja conozcan y acepten las condiciones del acompañamiento terapéutico.
            </p>
          ...
          <div className="mb-12">
            <div className="relative w-full aspect-[4/5] md:aspect-[4/3] rounded-2xl overflow-hidden border border-brand-pink/30 bg-gray-50 mb-6">
              <iframe
                ...
                marginHeight={0}
                marginWidth={0}
                title="Google Form Acuerdo Plan Intermedio"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="https://docs.google.com/forms/d/e/1FAIpQLSfYAQ3q9ZzBEkpgU-sGVE2ZVVbg_WhwQk2Xl-BVx6sTZzHUPw/viewform"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-primary flex items-center justify-center gap-2"
              >
                Firmar acuerdo del Plan Intermedio
